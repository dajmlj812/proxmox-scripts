...
# Base raw github URL
_raw_base="https://raw.githubusercontent.com/dajmlj812/proxmox-scripts/blob/main/lxc/nginx-proxy-manager"
#https://github.com/dajmlj812/proxmox-scripts/blob/main/lxc/nginx-proxy-manager
# Operating system
_os_type=alpine
_os_version=3.18
# System architecture
